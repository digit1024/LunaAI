//! Warning banner widget - dismissible security / caution display
...
/// Create a warning banner widget (amber style)
pub fn warning_banner<M: Clone + 'static>(message: &str, on_dismiss: M) -> Element<'static, M> {
    ...
    container(content)
        ...
        .style(|_theme| cosmic::widget::container::Style {
            ...
            border: cosmic::iced::Border {
                color: cosmic::iced::Color::from_rgb(0.7, 0.55, 0.15),
                width: 1.0,
                radius: 8.0.into(),
            },
            ..Default::default()
