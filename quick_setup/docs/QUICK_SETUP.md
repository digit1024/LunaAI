...
| cosmic-llm-memory | Luna history + memory | `mcp_luna_history`, `COSMIC_LLM_DB_PATH`. Binary downloaded automatically to `~/.local/share/cosmic_llm/bin/` when you opt in. |
